...
<div class="stats-row">
  ...
  <div class="card">
    ...
    <div style="font-size:.8rem;color:var(--g400);margin-top:.3rem"><?=(int)$stats['completados']?> servicios completados</div>
  </div>
  <div class="card">
...
<div class="charts-row">
  <div class="chart-card">
    <div class="chart-title">📈 Servicios por mes (<?=date('Y')?>)</div>
...
<!-- TOP MAIDS Y SERVICIOS RECIENTES -->
  ...
  <div class="chart-card">
    ...
    <div style="display:flex;flex-direction:column;gap:.6rem;padding:.5rem 0">
      <?php foreach($servicios_recientes as $s): 
        ...
        $iniciales_m = strtoupper(substr($s['mn'],0,1).substr($s['ma'],0,1));
      ?>
