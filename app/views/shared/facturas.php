...
<div class="card" style="cursor:pointer;transition:box-shadow .2s" onclick="toggleFactura(<?=(int)$f['id']?>)" onmouseover="this.style.boxShadow='0 4px 20px rgba(0,0,0,0.1)'" onmouseout="this.style.boxShadow=''">
  ...
  <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:1rem">
    <div style="display:flex;align-items:center;gap:1rem">
      <div style="width:48px;height:48px;border-radius:12px;background:var(--rose-light,#fce8ea);display:flex;align-items:center;justify-content:center;font-size:1.4rem">🧾</div>
      <div>
  ...
  <div id="detalle-<?=(int)$f['id']?>" style="display:none;margin-top:1.5rem;border-top:1px solid var(--g200);padding-top:1.5rem">
    ...
    <!-- RESUMEN FINANCIERO -->
    <div style="background:var(--g100);border-radius:var(--r);padding:1.2rem;max-width:400px;margin-left:auto">
    ...
    <div style="text-align:right;margin-top:1rem">
      <button onclick="imprimirFactura(<?=(int)$f['id']?>)" class="btn btn-outline btn-sm">🖨️ Imprimir factura</button>
    </div>
