...
<nav class="navbar">
  <div class="nav-inner">
    <a href="/dashboard" class="nav-brand"><img src="/images/logoSakura.png" alt="Sakura" style="width:80px;height:80px;border-radius:50;object-fit:contain;margin-right:.4rem"> <span>Sakura</span> Maid Services</a>
    <div class="nav-links">
